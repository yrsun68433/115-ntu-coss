...
export const MONTHS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'j2', text: '院學士招生：雙主修作業日程追蹤（轉入方審核）', desc: '院學士為轉入方（學生原系所在地的註冊組為轉出方），須依日程完成審核並送回註冊組。\n\n【作業日程】\n6/25（四）10:00　註冊組上傳申請學生名單及成績單，各單位可開始查詢、下載申請資料。\n6/30（二）　　　　原系完成轉出審核，並將同意名單送回註冊組（轉出截止）。\n7/2（四）10:00　　註冊組再次上傳資料供各轉入單位下載。\n7/2（四）起　　　　開放第二階段轉入審核，請以個人計中帳號登入系統辦理。\n7/17（五）　　　　院學士完成審核，經系主任（召集人）核章後送院。\n7/20（一）　　　　院長核章後送回註冊組（轉入截止）。\n7/27（一）　　　　註冊組彙整並審核各學系同意名單。\n7/30（四）　　　　簽請教務長核定。\n8/3（一）10:00　　公告核准名單並完成學籍變更。\n\n審核窗口：林佑宣（註冊組，yuhsuan405@ntu.edu.tw，62388轉219）\n\n審核標準：轉系須符合本校轉系辦法第3條；雙主修須符合全校共同規定（前一學年每學期GPA≧2.92或名次≦20%）。注意114-2學期名次可能因成績未到齊而浮動，審查時須留意。', done: false, note: '', attachment: '/115轉輔雙申請案多次用公文封：審核外系學生申請貴系轉輔雙用(轉入).docx', attachmentLabel: '下載審核公文封範本' },
